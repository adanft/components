...
describe('Button', () => {
  ...
  it('applies sm size styles', () => {
    ...
    expect(button).toHaveClass('text-sm', 'leading-8', 'px-4');
  });
  ...
  it('applies lg size styles', () => {
    ...
    expect(button).toHaveClass('text-lg', 'leading-12', 'px-8');
  });
  ...
  it('combines variant and size correctly', () => {
    ...
    expect(button).toHaveClass('bg-muted', 'text-white', 'text-sm', 'leading-8', 'px-4');
  });
