...
function Navbar({ profileProps, searchPlaceholder = 'Search' }: NavbarProps) {
  return (
    <div className="fixed left-16.25 top-0 right-0 h-24.25 ui-bg-surface-raised ui-border-default border-b ui-shadow-sm px-8 flex justify-between items-center z-10">
      <div></div>
