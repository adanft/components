      ...
      <span className={cn('relative inline-flex items-center', !disabled && 'cursor-pointer')}>
        ...
        <span
          ...
          className={cn(
            ...
            'peer-checked:bg-brand peer-focus-visible:outline-3 peer-focus-visible:outline-outline peer-focus-visible:outline-offset-1 peer-focus-visible:shadow-outline',
